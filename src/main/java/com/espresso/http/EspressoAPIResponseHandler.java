...
import com.espresso.http.exceptions.DataException;
import com.espresso.http.exceptions.GeneralException;
import com.espresso.http.exceptions.InputException;
import com.espresso.http.exceptions.NetworkException;
import com.espresso.http.exceptions.OrderException;
import com.espresso.http.exceptions.PermissionException;
import com.espresso.http.exceptions.EspressoAPIException;
import com.espresso.http.exceptions.TokenException;

import okhttp3.Response;

public class EspressoAPIResponseHandler {

	public JSONObject handle(Response response, String body) throws IOException, EspressoAPIException, JSONException {
//		System.out.println("***************************");
...
//	            + " " + responseBody, "AG8001");
	...
	private EspressoAPIException dealWithException(JSONObject jsonObject, String code) throws JSONException {
		...
		default:
			return new EspressoAPIException(jsonObject.getString("data not found"));
		}
	}
